...
import GOOGLEPAY_ICON from "../assets/images/payment/googlePay.png";
import APPLEPAY_ICON from "../assets/images/payment/applePay.png";
import PAYPAL_ICON from "../assets/images/payment/paypal.png";
        ...
        <div className="paymentPage__contents">
          <div className="paymentPage__contents--box">
            ...
            <div className="paymentPage__contents--box-accounts">
              <div>
                <img src={GOOGLEPAY_ICON} alt="google pay" />
                <span>Google Pay</span>
              </div>
              <div>
                <img src={APPLEPAY_ICON} alt="apple pay" />
                <span>Apple Pay</span>
              </div>
              <div>
